                ...
                <FlatList
                    ...
                    renderItem={({ item, index }) => {
                        return (
                            ...
                            >
                                {item.label == constants.screens.home ? <Home /> : <View></View>}
                                {item.label == constants.screens.search ? <Search /> : <View></View>}
                                {item.label == constants.screens.cart ? <Cart /> : <View></View>}
                                {item.label == constants.screens.favorite ? <Favorite /> : <View></View>}
                                {item.label == constants.screens.notification ? <Notification /> : <View></View>}
                            </View>
